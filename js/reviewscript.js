$(document).ready(function(){
	...
	$("select#fac2").change(function() {
        if ($("select#fac2 option:selected").val() == "FoS") {
            $("select#maj2 option").remove();
            $("select#maj2").append("<option value=> Select Major </option>");
            ...
            $("select#maj2").append("<option value='Project and Facilities Management'> Project and Facilities Management </option>");
    ...
    jQuery.validator.addMethod('Integer', function(value, element) {
        return this.optional(element) || /Chinese Language[0-9,]+$/i.test(value);
