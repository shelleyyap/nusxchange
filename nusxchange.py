    ...
    def get(self):
        ...
        if users.is_current_user_admin():
            template_values = {
                ...
                'url': users.create_logout_url('/countries'),
                'admin': users.is_current_user_admin(),
                'anocountries': ['australia', 'austria', 'belgium', 'canada', 'china', 'croatia','denmark', 'estonia', 'finland', 'france', 'germany', 'hongkong', 'hungary', 'japan', 'latvia', 'lithuania', 'mexico', 'netherlands', 'newzealand', 'norway', 'poland', 'romania', 'singapore', 'southafrica', 'southkorea', 'spain', 'sweden', 'switzerland', 'taiwan', 'turkey', 'uk', 'usa'],
                'countries': {'australia': "Australia", 'austria': "Austria", 'belgium': "Belgium", 'canada': "Canada",'china': "China", 'croatia': "Croatia", 'denmark': "Denmark", 'estonia': "Estonia", 'finland': "Finland", 'france': "France", 'germany': "Germany", 'hongkong': "Hong Kong", 'hungary': "Hungary", 'japan': "Japan", 'latvia': "Latvia", 'lithuania': "Lithuania", 'mexico': "Mexico", 'netherlands': "Netherlands", 'newzealand': 'New Zealand', 'norway': "Norway", 'poland': "Poland", 'romania': "Romania", 'singapore': "Singapore", 'southafrica': "South Africa", 'southkorea': 'South Korea', 'spain': "Spain", 'sweden': 'Sweden', 'switzerland': "Switzerland", 'taiwan': "Taiwan", 'turkey': "Turkey", 'uk': "United Kingdom", 'usa': 'United States of America'},
                'schools': {'australia': School.query(School.country == "Australia").fetch(), 'austria': School.query(School.country == "Austria").fetch(), 'belgium': School.query(School.country == "Belgium").fetch(), 'canada': School.query(School.country == "Canada").fetch(), 'china': School.query(School.country == "China").fetch(), 'croatia': School.query(School.country == "Croatia").fetch(),'denmark': School.query(School.country == "Denmark").fetch(), 'estonia': School.query(School.country == "Estonia").fetch(), 'finland': School.query(School.country == "Finland").fetch(), 'france': School.query(School.country == "France").fetch(), 'germany': School.query(School.country == "Germany").fetch(), 'hongkong': School.query(School.country == "HongKong").fetch(), 'hungary': School.query(School.country == "Hungary").fetch(), 'japan': School.query(School.country == "Japan").fetch(), 'latvia': School.query(School.country == "Latvia").fetch(), 'lithuania': School.query(School.country == "Lithuania").fetch(), 'mexico': School.query(School.country == "Mexico").fetch(), 'netherlands': School.query(School.country == "Netherlands").fetch(), 'newzealand': School.query(School.country == "NewZealand").fetch(), 'norway': School.query(School.country == "Norway").fetch(), 'poland': School.query(School.country == "Poland").fetch(), 'romania': School.query(School.country == "Romania").fetch(), 'singapore': School.query(School.country == "Singapore").fetch(), 'southafrica': School.query(School.country == "SouthAfrica").fetch(), 'southkorea': School.query(School.country == "SouthKorea").fetch(), 'spain': School.query(School.country == "Spain").fetch(), 'sweden': School.query(School.country == "Sweden").fetch(), 'switzerland': School.query(School.country == "Switzerland").fetch(), 'taiwan': School.query(School.country == "Taiwan").fetch(), 'turkey': School.query(School.country == "Turkey").fetch(), 'uk': School.query(School.country == "UnitedKingdom").fetch(), 'usa': School.query(School.country == "USA").fetch()}
            }
